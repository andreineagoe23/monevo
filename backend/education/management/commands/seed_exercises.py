    ...
    def handle(self, *args, **options):
        exercises_data = [
            ...
            # Budget Allocation Exercises
            {
                ...
                "correct_answer": {"Needs": 2000, "Wants": 1200, "Savings": 800},
                "category": "Budgeting",
                "difficulty": "beginner",
                "is_published": True,
            },
            {
                ...
                "exercise_data": {
                    ...
                    "target": {"category": "Savings", "min": 1200},
                    "hints": [
            ...
            },
            {
                ...
                "exercise_data": {
                    ...
                    "target": {"category": "Savings", "min": 1000},
                    "hints": [
        ...
        for exercise_data in exercises_data:
            ...
            existing = Exercise.objects.filter(
                question=exercise_data["question"], type=exercise_data["type"]
            ).first()

            if existing:
                self.stdout.write(
                    self.style.WARNING(
                        f'Skipping: "{exercise_data["question"][:50]}..." (already exists)'
                    )
                )
                skipped_count += 1
                continue
