...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "section",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="core.lessonsection"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, through="core.LessonCompletion", to="core.lesson"
                    ),
                ),
                (
                    "completed_sections",
                    models.ManyToManyField(
                        blank=True, through="core.SectionCompletion", to="core.lessonsection"
                    ),
                ),
                (
                    "course",
        ...
        migrations.AddField(
            ...
            name="user_progress",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="core.userprogress"
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reward",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="core.reward"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quiz",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="core.quiz"),
                ),
                (
                    "user",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "badge",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="core.badge"),
                ),
                (
                    "user",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fact",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="core.financefact"
                    ),
                ),
                (
                    "user",
