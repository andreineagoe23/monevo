  ...
  <section className="bg-[color:var(--bg-color,#f8fafc)] px-4 py-10">
    <GlassCard padding="xl" className="mx-auto w-full max-w-4xl space-y-6">
      <header className="space-y-3">
        <p className={mutedClass}>Last updated: April 07, 2025</p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to monevo.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to monevo, accessible from{" "}
              <a
    ...
    <p>
      If you have any questions about this Privacy Policy, You can contact us:
        ...
        <ul>
          <li>By email: monevo.tech@monevo.tech</li>
        </ul>
      </div>
    </GlassCard>
  </section>
